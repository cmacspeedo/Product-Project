...
// use console.log and pass in the product array to check if you have it set up correctly.
// console.log(productArray)

// Assignment 3:
// Hint: Use a loop(look up the javascript loop on w3schools.) on your product
//array and set the max length of the loop to the array using
